...
class Ex3Test {  // id:208999888
	...
	void testMySplit() {
		...
		assertEquals(Ex3.mySplit(new int[] {3,3}),false);
		assertEquals(Ex3.mySplit(new int[] {5,5}),false);
		assertEquals(Ex3.mySplit(new int[] {3,4,6,2,15}),true);
		assertEquals(Ex3.mySplit(new int[] {}),true);
	}
//
	@Test
